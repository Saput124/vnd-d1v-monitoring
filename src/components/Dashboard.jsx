      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mt-4 flex flex-col gap-2">
          ...
          <div className="text-sm text-gray-600 pl-6">
            Menampilkan <span className="font-semibold text-blue-600">{filteredProgress.length}</span> dari <span className="font-semibold">{progressData.length}</span> blok
            {progressData.length - filteredProgress.length > 0 && (
              <span className="text-orange-600 ml-2">
                ({progressData.length - filteredProgress.length} disembunyikan)
              </span>
            )}
          </div>
        </div>
